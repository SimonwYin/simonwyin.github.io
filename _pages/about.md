...
My research interests include **Machine Unlearning** and **Differential Privacy-based Privacy Preservation** for federated learning. In the area of machine unlearning, my work primarily revolves around **efficient provable federated unlearning** and **efficient verifiable LLM unlearning**. In the field of differential privacy-based privacy preservation for federated learning, I have recently been focusing on the design of **high-availability personalized differential privacy aggregation algorithms** to enhance federated learning systems.
